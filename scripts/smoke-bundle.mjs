...
assert.deepEqual(Object.keys(children), ['chat.input.model'])
assert.equal(children['chat.input.model'].kind, 'single')
assert.equal(children['chat.input.model'].scope, 'root')
const face = children['chat.input.model'].inject
assert.equal(typeof face.getDirectory, 'function')
